...
export class RepositoryService {
  ...
  users:Array<User>= [
    ...
    "groups":["Family","Work"],"img":"https://img.icons8.com/dusk/64/000000/old-man.png"},{"contact_id":2,"firstName":"margalite","lastName": "Sayada","website":new Website("www.margalite.co.il"),"username":new UserName("margalite"),"address":new Adress("shevet yehuda 5"),"meansOfContact":[new PhoneNumber("03-5794441"),new Email("margalite95@gmail.com")],"groups":["Freind","Work"],"img":"https://img.icons8.com/dusk/64/000000/old-man.png"}],

    "groups":[
      {"groupName":"Family","contacts":{1:{"contact_id":1,"firstName":"racheli","lastName": "cohen","website":new Website("www.rachel.co.il"),"username":new UserName("racheli"),"address":new Adress("shevet yehuda 5"),"meansOfContact":[new PhoneNumber("03-5794441"),new Email("rachli548@gmail.com "),new Adress("Bilu 5 Bnei-Brak")],
    "groups":["Family","Work"],"img":"https://img.icons8.com/dusk/64/000000/old-man.png"}},"group_id":1},
    {"groupName":"Work","contacts":{1:{"contact_id":1,"firstName":"racheli","lastName": "cohen","website":new Website("www.rachel.co.il"),"username":new UserName("racheli"),"address":new Adress("shevet yehuda 5"),"meansOfContact":[new PhoneNumber("03-5794441"),new Email("rachli548@gmail.com "),new Adress("Bilu 5 Bnei-Brak")],
    "groups":["Family","Work"],"img":"https://img.icons8.com/dusk/64/000000/old-man.png"},2:{"contact_id":2,"firstName":"margalite","lastName": "Sayada","website":new Website("www.margalite.co.il"),"username":new UserName("margalite"),"address":new Adress("shevet yehuda 5"),"meansOfContact":[new PhoneNumber("03-5794441"),new Email("margalite95@gmail.com")],"groups":["Freind","Work"],"img":"https://img.icons8.com/dusk/64/000000/old-man.png"}},"group_id":2},
    ...
    {"groupName":"Emergency","contacts":null,"group_id":4}]}
    
    , {"UserName":"margaliteSayada","Password":"234567","email":"margalite95@gmail.com",
    "contacts":[{"contact_id":1,"firstName":"shani","lastName": "romanov","website":new Website("www.shani.co.il"),"username":new UserName("shanoRomanov"),"address":new Adress("Harav Bloy 10 Bnei-Brak"),"meansOfContact":[new PhoneNumber("03-5794441"),new Email("shaniromanov@gmail.com ")],
    "groups":["OpenCourse","Freind"],"img":"https://img.icons8.com/dusk/64/000000/old-man.png"},{"contact_id":2,"firstName":"chavi","lastName": "berkovich","website":new Website("www.chavi.co.il"),"username":new UserName("chavi"),"address":new Adress("shevet yehuda 5"),"meansOfContact":[new PhoneNumber("03-5794441"),new Email("chavi@gmail.com")],"groups":["OpenCourse"],"img":"https://img.icons8.com/dusk/64/000000/old-man.png"}],
    "groups":[ 
      {"groupName":"Family","contacts":null,"group_id":1}, 
      {"groupName":"OpenCourse","contacts":{1:{"contact_id":1,"firstName":"shani","lastName": "romanov","website":new Website("www.shani.co.il"),"username":new UserName("shanoRomanov"),"address":new Adress("Harav Bloy 10 Bnei-Brak"),"meansOfContact":[new PhoneNumber("03-5794441"),new Email("shaniromanov@gmail.com ")],
      "groups":["OpenCourse","Freind"],"img":"https://img.icons8.com/dusk/64/000000/old-man.png"},2:{"contact_id":2,"firstName":"chavi","lastName": "berkovich","website":new Website("www.chavi.co.il"),"username":new UserName("chavi"),"address":new Adress("shevet yehuda 5"),"meansOfContact":[new PhoneNumber("03-5794441"),new Email("chavi@gmail.com")],"groups":["OpenCourse"],"img":"https://img.icons8.com/dusk/64/000000/old-man.png"}},"group_id":2},
